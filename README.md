## 最近更新
- 去掉了vue.js的cdn，因为会使得在Linux系统下build报错，推荐把主题更新到**1.0.7**
- 修复css代码意外丢失
...
- 已经发布到 npm,只需要把 package.json 中的主题版本号改为 **1.0.7**,然后删除 node_modules 文件夹,重新运行 npm i 或者最好用 cnpm i 即可
...
用 Lighthouse 来测试网站的截图，说明一下 SEO 并没有那么好，同时本主题对 SEO 的计划支持不高，使用之前您需要自己权衡选择，我的建议是如果要 SEO 请尽量发表到掘金，CSDN 等大平台
